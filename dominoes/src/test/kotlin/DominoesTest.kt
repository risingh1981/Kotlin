...
class DominoesTest {
    ...
    @Test
    fun `separate loops`() {
        val input = listOf(Domino(1, 2), Domino(2, 3), Domino(3, 1), Domino(1, 1), Domino(2, 2), Domino(3, 3))
        Dominoes.formChain(input).should { beValidDominoes(input) }
    }

    @Test
    fun `nine elements`() {
        val input = listOf(Domino(1, 2), Domino(5, 3), Domino(3, 1), Domino(1, 2), Domino(2, 4), Domino(1, 6), Domino(2, 3), Domino(3, 4), Domino(5, 6))
        Dominoes.formChain(input).should { beValidDominoes(input) }
    }
